...
rgba = r'(rgba\(\s*\b([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\b\s*,\s*\b([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\b\s*,\s*\b([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\b\s*,(\s*\b(0.[0-9]|1)\b\s*)\))'
rgb_percent = r'(rgb\(\s*(\d?\d%|100%)+\s*,\s*(\d?\d%|100%)+\s*,\s*(\d?\d%|100%)+\s*\))'
rgba_percent = r'(rgba\(\s*(\d?\d%|100%)+\s*,\s*(\d?\d%|100%)+\s*,\s*(\d?\d%|100%)+\s*,\s*\b(0.[0-9]|1)\b\s*\))'
hsl = r'(hsl\(\s*\b([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|3[0-6]0)\b\s*,\s*\b([0-9]|[1-9][0-9]|100)\b%\s*,\s*\b([0-9]|[1-9][0-9]|100)\b%\s*\))'
hsla = r'(hsla\(\s*\b([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|3[0-6]0)\b\s*,\s*\b([0-9]|[1-9][0-9]|100)\b%\s*,\s*\b([0-9]|[1-9][0-9]|100)\b%\s*,(\s*\b(0.[0-9]|1)\b\s*\)))'
